...
**实验室文件**：本实验的文件位于 _Allfiles\Labfiles\Starter\DP-200.6_ 文件夹。
...
1. 在Azure门户中，选择 **创建资源**，输入 **事件中心**，然后从得出的搜索中选择 **事件中心**。然后选择 **创建**。

1. 在“创建命名空间”边栏选项卡中，键入以下选项，然后单击 **“创建”**：
...
1. 在“告诉我们你的项目”页面中，选择“你感兴趣的用例是什么？”选项。按照本课程的目的选择**学生**。在“用你自己的话描述你正在构建的内容”中，用300个单词来解释为什么要使用它。下面是一个示例：

> **注意**：此屏幕中的问题和选项可以更改。

    >1.我正在使用 Twitter 的 API 来学习如何在学习应用程序中嵌入 twitter 语句。此帐户用于了解如何执行此操作
    >2.  我计划分析推文，以了解如何实时计算和阅读流推文，作为学习练习的一部分
    >3.我不打算以转发或点赞内容的形式与其他人的推文进行互动。我将阅读和计算推文并观察情绪。
    >4.将在应用程序中分析个人和聚集推文 
